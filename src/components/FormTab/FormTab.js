...
const FormTab = (props) => {
  const toView = (props.view ? "form" : "formNone");
  return (
<form method="POST" className={toView}>
              <p className={styles.formName}>Связь со мной</p>
            <div className={styles.textStar}>
              <p class="cursor-text">Обязательные поля</p>
